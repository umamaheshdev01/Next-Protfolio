...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_t6vukpw', 'template_wz3zqej', form.current, 'mSu5NIrOJcH2sn4Wa')
      .then((result) => {
        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">umamaheshdev01@gmail.com</span>

              <a href="mailto:umamaheshdev01@gmail.com" className="contact__button">
                Write me {" "}
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">8897944577</span>
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">Umamaheshdev01</span>

              <a href={data.twitter} className="contact__button">
                Write me {" "}
                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
              </a>
            </div>
